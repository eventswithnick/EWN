  ...
  async function createManualBooking(data) {
    ...
    if (hasRemote()) {
      try {
        ...
        systemNotice(`Manual booking was saved locally, but online save failed. Run the v7.3 SQL setup and try again.`, 'error');
      }
    }
  }
